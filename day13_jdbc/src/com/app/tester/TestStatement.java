...
public class TestStatement {
	...
	public static void main(String[] args) {
		try(// get db connection
			...
			//cursor is currently before the 1st row
			while(rst.next()) {
				/*
				 *  id | first_name | last_name | email | password | dob | status | role  |
				 */
				System.out.printf("Id %d Name %s %s Email %s "+"pwd %s DoB %s Status %b Role %s %n",
						rst.getInt(1),rst.getString(2),rst.getString(3),rst.getString(4),rst.getString(5),
						rst.getDate(6),rst.getBoolean(7),rst.getString(8));
			}
			//System.out.println("connected to DB "+cn);//imple class instance
